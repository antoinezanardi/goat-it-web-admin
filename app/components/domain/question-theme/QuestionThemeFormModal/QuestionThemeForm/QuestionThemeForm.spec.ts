...
describe("QuestionThemeForm Component", () => {
  ...
  describe("Exposed isFormValid", () => {
    it("should expose isFormValid as false initially when mounted.", () => {
      expect((wrapper.vm as InstanceType<typeof QuestionThemeForm>).isFormValid).toBeFalsy();
    });
  });
  ...
  describe("Exposed triggerFormSubmit", () => {
    it("should trigger UForm submission when triggerFormSubmit is called.", async() => {
      ...
      await (wrapper.vm as InstanceType<typeof QuestionThemeForm>).triggerFormSubmit();
  ...
  describe("Form submission", () => {
    it("should emit submitCreation with the form data when the form is submitted with valid data.", async() => {
      ...
      state.slug = "my-valid-slug";
      state.label = { en: "My Label", fr: undefined, es: undefined, de: undefined, it: undefined, pt: undefined };
      state.description = { en: "My Description", fr: undefined, es: undefined, de: undefined, it: undefined, pt: undefined };
      state.aliases = { en: undefined, fr: undefined, es: undefined, de: undefined, it: undefined, pt: undefined };
  ...
  describe("Form validation", () => {
    ...
    it("should set isFormValid to true when form has valid data and blur is triggered.", async() => {
      ...
      expect((wrapper.vm as InstanceType<typeof QuestionThemeForm>).isFormValid).toBeTruthy();
    });
