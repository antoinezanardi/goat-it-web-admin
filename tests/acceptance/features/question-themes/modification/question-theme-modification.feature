...
Feature: 🎨 Question Theme Modification
  ...
  Scenario: 🎨 Question Theme label is modified and updated in the list
    ...
    When the user clicks on the button with name "Edit"
    ...
    And the exact toast with text "Question theme modified successfully" should be visible
  ...
  Scenario: 🎨 Question Theme modification form shows error for duplicate slug
    ...
    When the user clicks on the element with testid "edit-button-theme-b"
