@question-themes @question-theme-archive
Feature: 🎨 Question Theme Archive
  ...
  Scenario: 🎨 Question Theme is archived after confirmation
    ...
    When the user clicks on the button with exact name "Archive question theme with slug music"
    ...
    And the toast with exact text "Question theme archived successfully" should be visible
