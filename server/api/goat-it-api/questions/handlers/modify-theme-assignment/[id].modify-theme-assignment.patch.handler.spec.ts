...
describe("Server Goat It API Questions Modify Theme Assignment Handler", () => {
  ...
  const fakeModificationDto = { isPrimary: true as const, isHint: false };
  const mockedEvent = { context: { params: { id: fakeId, themeId: fakeThemeId } }, body: fakeModificationDto } as unknown as H3Event;
